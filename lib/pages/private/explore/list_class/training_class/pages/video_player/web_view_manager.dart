...
class WebviewManager {
  static const NAME_WEBVIEW = 'webview.html';

  late String _type;
  static const String ASSET_NAME_INDEX = "assets/player.html";

  static const List<String> TYPE_ALLOWED = [
    'graph',
    'running',
    'cycling',
    'balance',
  ...
  WebviewManager({required String type}) : assert(TYPE_ALLOWED.contains(type)) {
    _type = type;
  }
  ...
  Future<String> configure(Map<String, dynamic> configuration) async {
    ...
    String _html = await rootBundle.loadString(ASSET_NAME_INDEX);

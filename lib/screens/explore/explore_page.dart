...
import 'package:prueba/screens/recipes_list/recipes_list_page.dart';
import 'package:prueba/screens/training_class_list/training_class_list_page.dart';
...
class ExploreTab extends StatelessWidget {
  ...
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => ExploreTab());
  }
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => isTraining
                              ? BlocProvider(
                                  create: (_) => TrainingListClassBloc(
                                      trainingClassListRepository:
                                          TrainingClassListRepository()),
